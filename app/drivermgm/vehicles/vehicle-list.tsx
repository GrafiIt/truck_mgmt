    ...
    <Card className="p-6">
      ...
      >
        ...
        <Table className="w-full text-sm">
          <TableHeader>
            <tr className="bg-gray-100 dark:bg-gray-800" style={{ position: "sticky", top: 0, zIndex: 10 }}>
              ...
              <th
                ...
                style={{ position: "sticky", left: 0, zIndex: 13, minWidth: "80px", width: "80px" }}
              >
                운전원
              </th>
              <th
                className="px-4 py-3 text-left font-semibold whitespace-nowrap bg-gray-100 dark:bg-gray-800"
                style={{ position: "sticky", left: 80, zIndex: 13, minWidth: "130px", width: "130px", boxShadow: "4px 0 6px -2px rgba(0,0,0,0.15)" }}
              >
                차량번호
              </th>
